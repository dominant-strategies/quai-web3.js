...
import {
    ...
    LogsOptions,
    PastLogsOptions
} from '@quainetwork/web3-core';
import {Subscription} from '@quainetwork/web3-core-subscriptions';
import {AbiCoder} from '@quainetwork/web3-eth-abi';
import {Accounts} from '@quainetwork/web3-eth-accounts';
import {Contract, ContractOptions} from '@quainetwork/web3-eth-contract';
import {Ens} from '@quainetwork/web3-eth-ens';
import {Iban} from '@quainetwork/web3-eth-iban';
import {Personal} from '@quainetwork/web3-eth-personal';
import {Network} from '@quainetwork/web3-net';
import {AbiItem} from '@quainetwork/web3-utils';
