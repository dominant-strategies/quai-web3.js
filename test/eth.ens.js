        ...
        assert.deepEqual(payload.params, [
            {
                ...
                data:
                    ...
                    abiCoder.encodeParameters(types, params).substr(2),
...
describe("ens", function () {
    ...
    describe("setters", function () {
        ...
        it("should set an approval by the given operator", async function () {
            ...
            prepareProviderForSetter(
                ...
                signature,
                ["address", "bool"],
                ["0x0123456701234567012345670123456701234567", true],
                false
            );
    ...
    describe("getters", function () {
        ...
        it('should call supportsInterface with the interfaceId and return "true" (promise)', async function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3(resolverSignature).slice(0, 10) +
                            "1757b5941987904c18c7594de32c1726cda093fdddacb738cfbc4a7cd1ef4370",
                        to: "0x00000000000c2e074ec69a0dfb2997ba6c7d2e1e",
                    },
                    "latest",
                ]);
            ...
            provider.injectResult(
                "0x0000000000000000000000000123456701234567012345670123456701234567"
            );
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3(supportsInterfaceSignature).slice(0, 10) +
                            sha3("addr(bytes32)").slice(2, 10) +
            ...
            const owner = await web3.eth.ens.supportsInterface(
                "foobar.eth",
                "0x3b3b57de"
            );
        ...
        it("should call supportsInterface with the signature and throw the expected error (promise)", async function () {
            ...
            try {
                await web3.eth.ens.supportsInterface(
                    "foobar.eth",
                    "addr(bytes32)"
                );
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3(signature).slice(0, 10) +
                            "00000000000000000000000001234567012345670123456701234567012345670000000000000000000000000123456701234567012345670123456701234567",
                        to: "0x00000000000c2e074ec69a0dfb2997ba6c7d2e1e",
                    },
                    "latest",
                ]);
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3(signature).slice(0, 10) +
                            "00000000000000000000000001234567012345670123456701234567012345670000000000000000000000000123456701234567012345670",
                        to: "0x00000000000c2e074ec69a0dfb2997ba6c7d2e1e",
                    },
                    "latest",
                ]);
        ...
        it("should call getAddress and return the expected address (promise)", async function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3("supportsInterface(bytes4)").slice(0, 10) +
                            addrInterfaceId +
                            "00000000000000000000000000000000000000000000000000000000",
                        to: "0x0123456701234567012345670123456701234567",
                    },
            ...
            provider.injectResult(
                "0x0000000000000000000000001234567012345670123456701234567012345670"
            );
        ...
        it("should call getAddress and return the expected address (callback)", function (done) {
            ...
            web3.eth.ens.getAddress("foobar.eth", function (error, addr) {
                assert.equal(
                    error,
                    "0x1234567012345670123456701234567012345670"
                ); // For backward compatibility
                assert.equal(
                    addr,
                    "0x1234567012345670123456701234567012345670"
        ...
        it("should call getPubkey and return the expected X and Y value (promise)", async function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3(pubkeySignature).slice(0, 10) +
                            "1757b5941987904c18c7594de32c1726cda093fdddacb738cfbc4a7cd1ef4370",
                        to: "0x0123456701234567012345670123456701234567",
                    },
                    "latest",
            ...
            const pubkeyCoordinateAsHex = asciiToHex(
            ...
            assert.equal(
                result[0][0],
                "0x3078303030303030303030303030303030303030303030303030303030303030"
            );
            assert.equal(
                result[0][1],
        ...
        it("should call getContent and return the expected content of the resolver (promise)", async function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.deepEqual(payload.params, [
                    {
                        data:
                            sha3(contentSignature).slice(0, 10) +
                            "1757b5941987904c18c7594de32c1726cda093fdddacb738cfbc4a7cd1ef4370",
                        to: "0x0123456701234567012345670123456701234567",
                    },
                    "latest",
        ...
        it("should error if resolver ABI does not support contenthash (promise)", async function () {
            ...
            try {
                ...
                assert(
                    error.message.includes(
                        'does not implement requested method: "contenthash"'
                    )
                );
            }
        });
        ...
        it("should error if resolver ABI does not support setContenthash (promise)", async function () {
            ...
            try {
                ...
                assert(
                    error.message.includes(
                        'does not implement requested method: "setContenthash"'
                    )
                );
            }
        });
